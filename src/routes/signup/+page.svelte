...
<div class="base" >
    <h1 class="text-4xl w-5/12 my-5 text-center">Unleash Your Productivity Potential with Just One Click!</h1>

    <form class="formBTN" method="post" action="/signup?/handleGoogleSignUp" use:enhance>
    ...
    <form class="formBTN" method="post" action="/signup?/handleGithubSignUp" use:enhance>
        <button  type="submit" class="continue_button">
            <svg class="w-8 h-8 me-2 px-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
